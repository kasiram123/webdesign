...
cap= cv2.VideoCapture("box123.mp4")#box2.mp4"
...
while cap.isOpened():
    ...
    yolo_model = cv2.dnn.readNetFromDarknet('yolov3/box_yolov4.cfg','yolov3/box_yolov4_best (1).weights')
   # yolo_model.setPreferableBackend(cv2.dnn.DNN_BACKEND_CUDA)
    ...
    print("box count:",len(max_value_ids))
